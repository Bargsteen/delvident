...
(function($PS) {
  ...
  var showTask = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericTask)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showInt))(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showString)))(new Data_Symbol.IsSymbol(function () {
      return "Task";
  }))));                                                                                                                                                                                                                                                               
  ...
  var hasMethodClientMethodJson = function (dictDecodeJson) {
      return function (dictIsSymbol) {
          return new HasMethodClients(function (method) {
              return function (v) {
                  return function (req) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Bifunctor.rmap(Data_Either.bifunctorEither)(function (v1) {
                          return v1.body;
                      ...
                      })(toAffjaxRequest(req)))))(function (r) {
                          if (r instanceof Data_Either.Left) {
                              return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error(Affjax.printError(r.value0)));
                          };
                          if (r instanceof Data_Either.Right) {
                              var v1 = Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)(r.value0);
                              if (v1 instanceof Data_Either.Left) {
                                  return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error(v1.value0));
                              };
                              if (v1 instanceof Data_Either.Right) {
                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1.value0);
                              };
                              throw new Error("Failed pattern match at Type.Trout.Client (line 214, column 9 - line 216, column 28): " + [ v1.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Type.Trout.Client (line 211, column 5 - line 216, column 28): " + [ r.constructor.name ]);
                      });
                  };
              };
          });
...
(function($PS) {
  ...
  var Type_Trout_ContentType_HTML = $PS["Type.Trout.ContentType.HTML"];
  var Type_Trout_PathPiece = $PS["Type.Trout.PathPiece"];                
  var clients = Type_Trout_Client.asClients(Type_Trout_Client.hasClientsLit(Type_Trout_Client.hasClientsAlt(Type_Trout_Client.hasClientsResource(Type_Trout_Client.hasClientsMethod(new Data_Symbol.IsSymbol(function () {
      return "GET";
  }))(Type_Trout_Client.hasMethodClientMethodJson(Data_Argonaut_Decode_Class.decodeArray(API.decodeJsonTask))(new Data_Symbol.IsSymbol(function () {
      return "GET";
      ...
      return "GET";
  }))(Type_Trout_Client.hasMethodClientMethodJson(API.decodeJsonTask)(new Data_Symbol.IsSymbol(function () {
      return "GET";
  ...
  var main = function __do() {
      Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Running client!")();
      var b = JQuery.body();
      return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Control_Bind.bind(Effect_Aff.bindAff)(clients.tasks.GET)(function (ts) {
          return Control_Bind.bind(Effect_Aff.bindAff)((clients.task(1)).GET)(function (singleTask) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("I got this single task: " + Data_Show.show(API.showTask)(singleTask))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(Data_Show.show(Data_Show.showArray(API.showTask))(ts))))(function () {
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(JQuery.setHtml(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)((function () {
                          var $0 = Type_Trout_ContentType_HTML.encodeHTML(API.encodeHTMLTask);
                          return function ($1) {
                              return Text_Smolder_Renderer_String.render($0($1));
                          };
                      })())(ts))(b));
                  });
              });
